...
'''This module will create graphs from catalog's query log file'''
...
ax[0].set_xlabel('Num of parallel rows queried')
ax[0].set_ylabel('Query time (sec)')
...
ax[1].set_xlabel('Num of parallel rows queried')
ax[1].set_ylabel('Query time (sec)')
ax[1].set_title('Single row query time for x rows')
plt.suptitle('Catalog query results')
plt.show()
plt.tight_layout()
